...
begin
  MainForma.HackButton.Caption := 'Применить';
  MainForma.IntegerRadio.Caption := 'Целое число';
  MainForma.StringRadio.Caption := 'Строка';
  MainForma.LoadButton.Caption := 'Прочитать...';
  MainForma.SaveButton.Caption := 'Записать';
  MainForma.SaveAsButton.Caption := 'Записать в...';
  MainForma.SettingsButton.Caption := 'Настройки';
  MainForma.AboutButton.Caption := 'О проге';
  MainForma.ExitButton.Caption := 'Выход';
  SettingsForma.Caption := 'Настройки';
  SettingsForma.ChgEditFontBtn.Caption := 'Сменить шрифт редактора';
  SettingsForma.WordWrapCheck.Caption := 'Перенос слов';
  SettingsForma.LangRadioGroup.Caption := 'Язык:';
  AboutForma.Caption := 'О проге';
  AboutForma.VersionLbl.Caption := 'String Hacker, версия 1.6L (сборка 12 июня 2022 года)';
  AboutForma.CopyrightLbl.Caption := 'Автор: Иван Мовчан. Copyright (c) 2022';
end;
